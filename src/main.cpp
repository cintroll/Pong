...
bool carrega_arquivos() {
  ...
  background2 = load_image("assets/background2.png");
  menu = load_image("assets/menu1.png");
  menu2 = load_image("assets/menu2.png");
  credito = load_image("assets/credito.bmp");
  barra = load_image("assets/barra.png");
  bola = load_image("assets/bola.png");
  bloco = load_image("assets/bloco.png");
  font = TTF_OpenFont("assets/verdana.TTF", 18);
  font2 = TTF_OpenFont("assets/verdana.TTF", 20);
